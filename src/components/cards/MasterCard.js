...
function MasterCard(props) {
    ...
    const fechData = () => {
            ...
            .then(res => {
                let heroes = res.data.data.map((hero) => {
                    return {
                        ...
                        desvantagens: hero.desvantagens, pericias: hero.pericias, armas: hero.armas, magias: hero.magias, xpTotal: hero.xpTotal, xpGasto: hero.xpGasto
                    }
                });
        ...
        axios.get(`${Utils.api()}hero/stats/`)
            .then(res => {
                            ...
                            <div className="row">
                                    ...
                                    <div className="info-box bg-success">
                                        ...
                                        <div className="info-box-content">
                                            ...
                                            <div className="progress">
                                                <div className="progress-bar" style={{ width: (params.hero.data.atualPV * 100) / params.hero.data.totalPV + "%" }}></div>
                                            </div>
                                            <span className="progress-description">
                                                {Math.floor((params.hero.data.atualPV * 100) / params.hero.data.totalPV) + "% restantes"}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-12">
                                    <div className="info-box bg-info">
                                        ...
                                        <div className="info-box-content">
                                            <span className="info-box-text">Pontos de Magia</span>
                                            <span className="info-box-number">{params.hero.data.atualPM}</span>
                                            <div className="progress">
                                                <div className="progress-bar" aria-valuemin={0} style={{ width: (params.hero.data.atualPM * 100) / params.hero.data.totalPM + "%" }}></div>
                                            </div>
                                            <span className="progress-description">
                                                {Math.floor((params.hero.data.atualPM * 100) / params.hero.data.totalPM) + "% restantes"}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-12">
                                    <div className="info-box bg-warning">
                                        <span className="info-box-icon"><i className="fas fa-hand-fist"></i></span>
                                        <div className="info-box-content">
                                            <span className="info-box-text">Força de Ataque</span>
                                            <span className="info-box-number">{params.hero.data.Habilidade + params.hero.data.AtributoAtaque}</span>
                                            <div className="progress">
                                                <div className="progress-bar" style={{ width: "100%" }}></div>
                                            </div>
                                            <span className="progress-description">
                                                {"Acerto Crítico: " + (params.hero.data.Habilidade + (params.hero.data.AtributoAtaque * 2))}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-12">
                                    <div className="info-box bg-danger">
                                        <span className="info-box-icon"><i className="fas fa-shield"></i></span>
                                        <div className="info-box-content">
                                            <span className="info-box-text">Força de Defesa</span>
                                            <span className="info-box-number">{params.hero.data.Habilidade + params.hero.data.Armadura}</span>
                                            <div className="progress">
                                                <div className="progress-bar" style={{ width: "100%" }}></div>
                                            </div>
                                            <span className="progress-description">
                                                {"Acerto Crítico:  " + (params.hero.data.Habilidade + (params.hero.data.Armadura * 2))}
                                            </span>
                                        </div>
                                    </div>
                                </div>
